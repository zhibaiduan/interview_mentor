# Interview Mentor — 面试前设置页完整规格

**文档性质** PRD 附录，聚焦「设置页」模块  
**更新时间** 2026-06-08（v1.4：默认值设计 + MVP 题型收紧为 3+2）  
...
| 从已保存简历调用 | 下拉选择 | ❌ P1 | 个人主页已保存的简历快速复用 |
...
- 用户可以手动粘贴，也可以在 P1 阶段从个人主页已保存简历中一键调用
...
*本文档配合《Interview Mentor MVP PRD》和《Multi-Agent 反馈系统设计规格》使用。*
